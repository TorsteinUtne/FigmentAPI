...
namespace PowerService.Data.Migrations
{
    ...
    [Migration("20210511103830_110521_3")]
    partial class _110521_3
    {
            ...
            modelBuilder.Entity("PowerService.Data.Models.Organization", b =>
                {
                    ...
                    b.HasIndex("OrganizationLicenseId")
                        .IsUnique()
                        .HasFilter("[OrganizationLicenseId] IS NOT NULL");
            ...
            modelBuilder.Entity("PowerService.Data.Models.Organization", b =>
                {
                    ...
                    b.HasOne("PowerService.Data.Models.LicenseType", "OrganizationLicense")
                        .WithOne("Organization")
                        .HasForeignKey("PowerService.Data.Models.Organization", "OrganizationLicenseId");
                });
